...
class MostRecomendedShowsViewModel(private val context: ScrobleApplication) : AndroidViewModel(context) {
    ...
    init {
        ...
        shows = Transformations.map(showService.getMostRecommendedShows()) { it.map { it.show } }
