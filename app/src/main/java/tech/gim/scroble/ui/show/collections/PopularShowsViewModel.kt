...
class PopularShowsViewModel(private val context: ScrobleApplication) : AndroidViewModel(context) {
    ...
    init {
        ...
        shows = Transformations.map(showService.getPopularShows()) { it.map { it.show } }
