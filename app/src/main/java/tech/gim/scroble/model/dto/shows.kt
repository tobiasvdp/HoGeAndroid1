...
data class DetailedShow(
    var title: String = "",    var year: Int = -1,    var ids: ReferenceData = ReferenceData(),    var overview: String = "",
    var first_aired: String? = "",    var airs: AirTime = AirTime(),    var runtime: Int = -1,    var certification: String? = "",
    var network: String? = "",    var country: String? = "",    var updated_at: String? = "",    var trailer: String? = "",
    var homepage: String? = "",    var status: String? = "",    var rating: Double? = -1.0,    var votes: Int? = -1,
    var comment_count: Int? = -1,    var language: String? = "",    var available_translations: Array<String>? = arrayOf(),
    var genres: Array<String>? = arrayOf(),    var aired_episodes: Int? = -1
)
...
data class DetailedEpisode(
    ...
    var number_abs: Int? = null, var overview: String? = null, var first_aired: String? = null, var updated_at: String? = null,
    var rating: Double? = -1.0, var votes: Int? = -1, var comment_count: Int? = -1, var available_translations: Array<String>? = arrayOf(),
    var runtime: Int? = -1
)
